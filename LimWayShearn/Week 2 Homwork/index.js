...
function displayElement (showList,element) {
    if (showList[0].getAttribute('data-') + showList[1].getAttribute('data-') + showList[2].getAttribute('data-') == '111') {
